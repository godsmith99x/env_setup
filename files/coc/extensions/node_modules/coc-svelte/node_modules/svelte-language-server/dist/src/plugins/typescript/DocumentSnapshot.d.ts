...
export declare class SvelteDocumentSnapshot implements DocumentSnapshot {
    ...
    private fragment?;
    version: number;
    constructor(parent: Document, parserError: ParserError | null, scriptKind: ts.ScriptKind, text: string, nrPrependedLines: number, exportedNames: IExportedNames, tsxMap?: RawSourceMap | undefined, htmlAst?: TemplateNode | undefined);
    get filePath(): string;
