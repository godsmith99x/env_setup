...
class CSSPlugin {
    ...
    getSelectionRange(document, position) {
        ...
        const [range] = (0, service_1.getLanguageService)(extractLanguage(cssDocument)).getSelectionRanges(cssDocument, [cssDocument.getGeneratedPosition(position)], cssDocument.stylesheet);
        if (!range) {
            return null;
        }
    ...
    getDiagnostics(document) {
        ...
        return (0, service_1.getLanguageService)(kind)
    ...
    doHoverInternal(cssDocument, position) {
        const hoverInfo = (0, service_1.getLanguageService)(extractLanguage(cssDocument)).doHover(cssDocument, cssDocument.getGeneratedPosition(position), cssDocument.stylesheet);
            ...
            lang.setCompletionParticipants([
                {
                    onCssProperty: (context) => {
                        if (context === null || context === void 0 ? void 0 : context.propertyName) {
                            emmetResults =
                                (0, vscode_emmet_helper_1.doComplete)(cssDocument, cssDocument.getGeneratedPosition(position), (0, service_1.getLanguage)(type), this.configManager.getEmmetConfig()) || emmetResults;
                        }
                    },
    ...
    getDocumentColors(document) {
        ...
        return (0, service_1.getLanguageService)(extractLanguage(cssDocument))
    ...
    updateConfigs() {
        var _a, _b, _c;
        (_a = (0, service_1.getLanguageService)('css')) === null || _a === void 0 ? void 0 : _a.configure(this.configManager.getCssConfig());
        (_b = (0, service_1.getLanguageService)('scss')) === null || _b === void 0 ? void 0 : _b.configure(this.configManager.getScssConfig());
        (_c = (0, service_1.getLanguageService)('less')) === null || _c === void 0 ? void 0 : _c.configure(this.configManager.getLessConfig());
    }
